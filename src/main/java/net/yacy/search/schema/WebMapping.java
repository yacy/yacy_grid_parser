...
import net.yacy.cora.federate.solr.MappingDeclaration;
import net.yacy.cora.federate.solr.MappingType;
...
public enum WebMapping implements MappingDeclaration {
    ...
    coordinate_p_0_coordinate(MappingType.coordinate, true, false, false, false, false, "automatically created subfield, (latitude)"),
