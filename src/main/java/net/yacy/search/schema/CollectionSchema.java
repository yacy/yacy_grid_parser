...
public enum CollectionSchema implements SchemaDeclaration {
    ...
    // mandatory
    url_s(SolrType.string, true, true, false, true, true, "url of document", true), // a 'sku' is a stock-keeping unit, a unique identifier and a default field in unmodified solr.
    ...
    referrer_url_s(SolrType.string, true, true, false, false, false, "id of the referrer to this document, discovered during crawling"),// byte[] referrerHash();
