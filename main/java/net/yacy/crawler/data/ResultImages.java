...
public class ResultImages {
    ...
    public static void registerImages(final MultiProtocolURL source, final Document document, final boolean privateEntry) {
        if (document == null) return;
        if (source == null) return;

        limitQueues(1000);

        final Map<MultiProtocolURL, ImageEntry> images = document.getImages();
