...
public class ImageEntry implements Comparable<ImageEntry>, Comparator<ImageEntry> {
    ...
    private final MultiProtocolURL imageurl;
    private MultiProtocolURL linkurl;
     ...
     */
    public ImageEntry(
            final MultiProtocolURL imageurl,
            final String alt,
            final int width,
            final int height,
            long fileSize) {
    ...
    public void setLinkurl(MultiProtocolURL linkurl) {
        this.linkurl = linkurl;
    }
    
    public MultiProtocolURL linkurl() {
        return this.linkurl;
    }
